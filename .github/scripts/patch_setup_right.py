...
"""+old
assert old in s; p.write_text(s.replace(old,insert,1))
p=Path('index.html'); s=p.read_text()
old="let onlineSelectedMode=null,onlineReadyState=false,onlineSocket=null,onlineRoom=null,onlineGameState=null,onlineSetupSelectedRegions=[];"
new="let onlineSelectedMode=null,onlineReadyState=false,onlineSocket=null,onlineRoom=null,onlineGameState=null,onlineSetupSelectedRegions=[],onlineSetupDraft={color:null,portrait:null};"
...
function renderOnlineAuthoritativeSetup(state){
 ...
 else{$('setupText').innerHTML='Province <b>'+me.province+'</b><br>Choisissez votre couleur et votre faction, puis cliquez sur <b>2 régions</b> de votre province directement sur la carte.<br>Placement : <b>'+onlineSetupSelectedRegions.length+'/2</b>';
